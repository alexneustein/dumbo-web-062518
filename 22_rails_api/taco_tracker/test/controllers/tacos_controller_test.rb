...
class TacosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taco" do
    assert_difference('Taco.count') do
      post tacos_url, params: { taco: { name: @taco.name, shell: @taco.shell, spiciness: @taco.spiciness } }
    end
  ...
  test "should update taco" do
    patch taco_url(@taco), params: { taco: { name: @taco.name, shell: @taco.shell, spiciness: @taco.spiciness } }
